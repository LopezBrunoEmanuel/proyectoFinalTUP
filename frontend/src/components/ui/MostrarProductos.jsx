...
const MostrarProductos = ({ productos }) => {
  ...
  const handleCambiarCantidad = (idProducto, accion, stock) => {
    setCantidades((prev) => {
      ...
      if (accion === "sumar" && actual < stock)
        return { ...prev, [idProducto]: actual + 1 };
      if (accion === "restar" && actual > 1)
        return { ...prev, [idProducto]: actual - 1 };
      return prev;
    });
  };
            ...
            <Card className="producto-card shadow-sm h-100">
              ...
              <Card.Body className="d-flex flex-column justify-content-between">
                ...
                <div className="botones-cards d-flex justify-content-between align-items-center mt-2 flex-wrap gap-2">
                  ...
                  <ViewButton
                    producto={prod}
                    onOpenModal={handleOpenShowModal}
                  />
                  ...
                  <div className="cantidad-container d-flex align-items-center gap-2">
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => {
                        ...
                        if (nuevaCantidad > prod.stockProducto)
                          nuevaCantidad = prod.stockProducto;
                        setCantidades((prev) => ({
                          ...prev,
                          [prod.idProducto]: nuevaCantidad,
                        }));
                      }}
                    />
                    ...
                    <Button
                      ...
                      disabled={
                        (cantidades[prod.idProducto] || 1) >= prod.stockProducto
                      }
                    >
                      +
                    </Button>
